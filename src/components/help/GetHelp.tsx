              ...
              <div className="space-y-4">
                <div className="bg-gray-700/50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold mb-2">
                    How do I use the UIVora?
                  </h3>
                  <p className="text-gray-300">
                    The UIVora allows you to write and test HTML, CSS, and
                    JavaScript code in real-time. Select your preferred language
                    from the tabs and start coding!
                  </p>
                </div>
                <div className="bg-gray-700/50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold mb-2">
                  ...
                  <p className="text-gray-300">
                    You can use Framer Motion, GSAP, and Anime.js, and in react
                    you don't need to import anything just start using it.
                  </p>
                </div>
                <div className="bg-gray-700/50 p-4 rounded-lg">
                  <h3 className="text-lg font-semibold mb-2">
                  ...
                  <p className="text-gray-300">
                    Currently, there is a limit of 10MB per code snippet to
              ...
              <div className="space-y-4">
                <div className="bg-gray-700/50 p-4 rounded-lg">
                  ...
                  <p className="text-gray-300">
                    ...
                    <a
                      href="mailto:support@playground.com"
